...
class Motor(object):
    ...
    def __init__(self, driver, pwn_channel, forwards_channel, backwards_channel, factor=1.0, speed=0, frequency=60,
                 reduction=0.0):
        ...
        self.speed = speed
        self.forwards_channel = forwards_channel
        self.backwards_channel = backwards_channel
        self.driver = driver
        self.pwn_channel = pwn_channel

    def toggle(self, direction):
        self.direction = direction
        self.driver.write(self.forwards_channel, 0, 4095 if direction == MotorDirection.FORWARDS else 0)
        self.driver.write(self.backwards_channel, 0, 4095 if direction == MotorDirection.BACKWARDS else 0)
    ...
    def update(self, speed=None):
        ...
        self.driver.write(self.pwn_channel, 0, abs(int(self.speed * self.factor * (1 - self.reduction))))

    def stop(self):
        self.driver.write(self.pwn_channel, 0, 0)
